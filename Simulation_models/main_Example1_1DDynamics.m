%% Main Scirpt for 1D example model
clc
clear
close all;
...
u_max = [100.0]; % in rad/sec

% Initialize dynamics
fprintf("initializing determinstic dynamics of example model...\n")
doi = 0.005; % degree of instability
sigma_squared = 0.005; % Noise variance
dyn = Example1_1DDynamics(doi, sigma_squared);
